...
public class CWarehouseDocument_Controller : CWarehouse_Controller_Base
{
        ...
        string p_strLast_Updated_By = "", string p_strLast_Updated_By_Function = "")
    {
        ...
        {
            p_objData.Auto_ID = Scalar_ID("sp_XNK_Nhap_Kho_Save_Header", p_objData.Auto_ID, p_objData.So_Phieu, p_objData.Kho_ID, p_objData.NCC_ID,
                p_objData.Ngay_Chung_Tu, p_objData.Ghi_Chu, p_objData.Created_By, p_objData.Created_By_Function,
                p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
        }
        else
        {
            p_objData.Auto_ID = Scalar_ID("sp_XNK_Xuat_Kho_Save_Header", p_objData.Auto_ID, p_objData.So_Phieu, p_objData.Kho_ID,
                p_objData.Ngay_Chung_Tu, p_objData.Ghi_Chu, p_objData.Created_By, p_objData.Created_By_Function,
                p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
        }
        ...
        string p_strLast_Updated_By = "", string p_strLast_Updated_By_Function = "")
    {
        ...
        if (p_bIs_Receipt)
        {
            p_objData.Auto_ID = Scalar_ID("sp_XNK_Nhap_Kho_Save_Detail", p_objData.Auto_ID, p_objData.Document_ID, p_objData.San_Pham_ID,
                p_objData.So_Luong, p_objData.Don_Gia, p_objData.Created_By, p_objData.Created_By_Function,
                p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
        }
        else
        {
            p_objData.Auto_ID = Scalar_ID("sp_XNK_Xuat_Kho_Save_Detail", p_objData.Auto_ID, p_objData.Document_ID, p_objData.San_Pham_ID,
                p_objData.So_Luong, p_objData.Don_Gia, p_objData.Created_By, p_objData.Created_By_Function,
                p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
        }
